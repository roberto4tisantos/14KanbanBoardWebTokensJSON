    ...
    return (<>
      <div className='container'>
        <form className='form' onSubmit={handleSubmit}>
          ...
          <textarea id='tName' name='name' value={newTicket?.name || ''} onChange={handleTextAreaChange}/>
          ...
          <textarea id='tDescription' name='description' value={newTicket?.description || ''} onChange={handleTextAreaChange}/>
          ...
          <select name='assignedUserId' value={newTicket?.assignedUserId || ''} onChange={handleUserChange}>
            ...
            return (<option key={user.id} value={String(user.id)}>
                  {user.username}
                </option>);
